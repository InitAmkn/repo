...
palindromeСheck(24523242); //Добавил возможность проверять числа с любым кол-вом цифр в рамках типа Integer
palindromeСheck(125521);
palindromeСheck(123456789);
